...
- (void)viewDidLoad
{
    ...
    if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
    {
        ...
        {
            // iPhone Classic
            [[NSBundle mainBundle] loadNibNamed:@"SatelliteViewController" owner:self options:nil];
        }
        if(result.height == 568)
        {
            // iPhone 5
            [[NSBundle mainBundle] loadNibNamed:@"SatelliteViewController-568h" owner:self options:nil];
        }
    }
