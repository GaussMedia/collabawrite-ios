...
@interface MoreStoriesViewController ()

@end

@implementation MoreStoriesViewController

@synthesize CancelBtn;
@synthesize mStoriesLbl;
@synthesize mCollectionLbl;
@synthesize mHeadingLbl;
@synthesize mSubheadingLbl;
@synthesize mUrlLbl;
...
- (void)viewDidLoad
{
    ...
    if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
    {
        ...
        {
            // iPhone Classic
            [[NSBundle mainBundle] loadNibNamed:@"MoreStoriesViewController" owner:self options:nil];
        }
        if(result.height == 568)
        {
            // iPhone 5
            [[NSBundle mainBundle] loadNibNamed:@"MoreStoriesViewController-568h" owner:self options:nil];
        }
    }
