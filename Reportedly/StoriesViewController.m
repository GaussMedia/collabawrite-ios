...
- (void)viewDidLoad
{
    ...
    if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
    {
        ...
        {
            // iPhone Classic
            [[NSBundle mainBundle] loadNibNamed:@"StoriesViewController" owner:self options:nil];
        }
        if(result.height == 568)
        {
            // iPhone 5
            [[NSBundle mainBundle] loadNibNamed:@"StoriesViewController-568h" owner:self options:nil];
        }
    }
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    PostImage.image = [UIImage imageNamed:@"taj.png"];
    /*
    ...
    NameLbl.frame=CGRectMake(20,119, 150,20);
    ...
    DescriptionLbl.text=@"The tombs of Mumtaz Mahal and Shah Jahan are encased within.Topped by a bronze finial which was made of gold.";
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIAlertView *alert1 = [[UIAlertView alloc]initWithTitle:@"Reportedly" message:@"Row Clicked!" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
    [alert1 show];
    //    NotificationViewController *NotifyVC=[[NotificationViewController alloc]initWithNibName:@"NotificationViewController" bundle:[NSBundle mainBundle]];
