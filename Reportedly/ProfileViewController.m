...
@synthesize mReportsLbl;
@synthesize mRecommendationsLbl;
...
- (void)viewDidLoad
{
    ...
    if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
    {
        ...
        {
            // iPhone 5
            [[NSBundle mainBundle] loadNibNamed:@"ProfileViewController-568h" owner:self options:nil];
        }
    }
...
{
    EditProfileViewController *SignupVC=[[EditProfileViewController alloc]initWithNibName:@"EditProfileViewController" bundle:[NSBundle mainBundle]];
